    ...
    <div className="bg-red-600 text-white text-sm px-4 py-2">
      ...
      <div className="hidden md:flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4 text-sm">
          ...
          <a href="https://wa.me/7386055697">
            <FaWhatsapp className="text-xl" />
          </a>

          <span className="font-semibold ml-4">Get Social</span>
          <a href="https://www.facebook.com/profile.php?id=61576593147953">
            <FaFacebookF className="text-xl" />
          </a>
          <a href="https://x.com/sandipuniv">
            <FaXTwitter className="text-xl" />
          </a>
          <a href="https://in.linkedin.com/school/sandipuniversity/ ">
            <FaLinkedinIn className="text-xl" />
          </a>
          <a href="https://www.instagram.com/sandip_university25?igsh=Mmx4NTlqYnFhNjMw">
            <FaInstagram className="text-xl" />
          </a>
          <a href=" youtube.com/channel/UCDAaVM3kH_Jk7jgSaQj5xFw">
